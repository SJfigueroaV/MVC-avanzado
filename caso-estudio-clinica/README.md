...
4. Cuando la bodega cambia, avisa a sus observadores (`agregarObservador`, con simples `Runnable`, sin
...
|---|---|---|
| `Paciente` | Entidad | Documento, nombre, diagnóstico y si ya fue dado de alta. |
| `ClinicaModel` | Modelo | Guarda el `ArrayList<Paciente>`, valida los datos y que no se repita el documento, da de alta y avisa a los observadores cuando algo cambia. |
...
| `Main` | — | Crea el Modelo compartido, las dos vistas y los dos controladores. |
